  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-xs text-slate-500 font-semibold mt-0.5">Track shipping, delivery slots, and payment status updates</p>
      </div>
      ...
      <div className="bg-white rounded-3xl border border-slate-200/60 p-12 text-center max-w-lg mx-auto shadow-sm space-y-4">
        ...
        <div className="space-y-1">
          <p className="text-xs font-bold text-slate-700">Order Management Foundation</p>
          <p className="text-[10px] text-slate-450 font-semibold leading-relaxed max-w-xs mx-auto">
            This module will be fully integrated with shipment and status lifecycle updates in subsequent Sprint 8D development.
          </p>
        </div>
      </div>
    </div>
